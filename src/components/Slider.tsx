const Slider = () => {
  return (
    <div className=" absolute top-0 ">
      <div className="flex flex-col md:flex-row items-center h-full md:items-start justify-between bg-transparent p-8 text-white">
        <div className="md:w-1/2 flex flex-col items-start justify-center">
          ...
          <a
            href="/simulation"
            className="mt-10 custom-button bg-gradient-to-r from-teal-400 to-blue-500 border-none text-white font-bold py-3 px-6 rounded-lg hover:from-blue-500 hover:to-teal-400 transition duration-300"
          >
            Explore Now
          </a>
        </div>
